...
SOURCE_PATHS = {
    ...
    "causal_loop/engine_v07.py": ROOT / "causal_loop/engine_v07.py",
    "causal_loop/engine_v06.py": ROOT / "causal_loop/engine_v06.py",
    "causal_loop/engine_legacy.py": ROOT / "causal_loop/engine_legacy.py",
...
ALLOWED_NAMES = (
    ...
    "causal_loop/engine_legacy.py",
    "causal_loop/engine_v06.py",
    "causal_loop/engine_v07.py",
